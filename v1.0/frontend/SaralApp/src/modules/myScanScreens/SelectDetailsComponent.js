        ...
        this.setState({
            ...
            if (valid) {
                ...
                if (subjectsData[subIndex] === 'attendance' && selectedDayType === 'Holiday') {
                    this.callCustomModal(Strings.message_text, "By selecting the 'Holiday' type, the attendance will be recorded and marked as a holiday entry.", false, this.navBack);
                    this.setState({
                        isLoading: false
                    });
                    return;
